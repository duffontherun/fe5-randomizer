...
#unit writing
for x in range(0, 52):
    exec("romhand.seek(%s.origoff, os.SEEK_SET)" % unit_exec_class[x])
    exec("romhand.write(%s.writable())" % unit_exec_class[x])
for x in range(0, 50):
    exec("romhand.seek(%s.origoff, os.SEEK_SET)" % unit_exec_class_boss[x])
    exec("romhand.write(%s.writable())" % unit_exec_class_boss[x])
#promo writing/correcting
if promotions == "1":
    romhand.seek(0x402F3 + (3 * 0), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 1), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 2), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 3), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 4), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 5), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 6), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 7), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 8), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 9), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 10), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 11), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 12), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 13), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 14), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 15), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 16), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 17), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 18), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 19), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 20), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 21), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 22), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 23), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 24), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 25), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 26), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 27), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 28), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 29), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 30), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 31), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
    romhand.seek(0x402F3 + (3 * 32), os.SEEK_SET)
    romhand.write(bytes([promo[random.randint(0, 50)]]))
else:
    romhand.seek(0x402F3 + (3 * 0), os.SEEK_SET)
...
if fow == "1":
    for x in range(0, 35):
        romhand.seek(0x2004A + (48 * x) + 35, os.SEEK_SET)
        romhand.write(bytes([random.randint(fow_min, fow_max)]))
if chapter_music == "1":
    for x in range(0, 35):
        romhand.seek(0x2004A + (48 * x) + 43, os.SEEK_SET)
        romhand.write(bytes([random.randint(1, 64)]))
        romhand.seek(0x2004A + (48 * x) + 44, os.SEEK_SET)
        romhand.write(bytes([random.randint(1, 64)]))
        romhand.seek(0x2004A + (48 * x) + 45, os.SEEK_SET)
        romhand.write(bytes([random.randint(1, 64)]))
